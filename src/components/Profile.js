   ...
   function onEditFlagChange(){
    ...
    useEffect(() => {
       ...
       <Loader/>
        ...
        { //when user will see his/her own profile , edit icon will be shown ,when they will click on the icon then they can edit there info
          if(userName===user&&editFlag==false)   
          {
            return (<div style={{width: "60%",marginLeft:"20%"}}  >
        <div class="ui segment " style={{backgroundImage: "linear-gradient(120deg, #84fab0 0%, #8fd3f4 100%)"}}>
            <div class="ui two column grid">
  <div class="column">
  <i class="edit icon" onClick={onEditFlagChange}>  </i>Edit Profile
      <img class="ui medium circular image" src={profilePic}/>
